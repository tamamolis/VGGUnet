...
np.random.seed(0o7) # 0bserver07 for reproducibility
data_shape = 360*480
...
segnet_basic.add(Convolution2D(7, 1, 1, border_mode='valid',))
segnet_basic.summary()

segnet_basic.add(Reshape((7, data_shape), input_shape=(7, 360, 480)))
